			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($products as $product): ?>
					<tr>
						...
						<td><?php echo h($product['Product']['measure']); ?>&nbsp;</td>
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $product['Product']['id']), array('escape' => false), __('¿Esta seguro(a) de eliminar # %s?', $product['Product']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
