					...
					<div class="panel-heading">Acciones</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
																...
																<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Eliminar'), array('action' => 'delete', $this->Form->value('Provider.id')), array('escape' => false), __('¿Esta seguro(a) de eliminar # %s?', $this->Form->value('Provider.id'))); ?></li>
